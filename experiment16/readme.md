...
## 📌 Title
**Experiment 16: Integrate CD pipeline in Testing Backend using Docker and GitHub Actions**

---

## 🎯 Aim
To containerize the backend testing application using Docker and set up a Continuous Deployment (CD) pipeline using GitHub Actions.
...
* **Trigger:** Push to `main` branch (specifically when changes are made to `experiment16/backend/**`).
